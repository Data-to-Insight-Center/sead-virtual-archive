...
import org.dataconservancy.dcs.access.client.ui.XmlPopupPanel;

import java.util.*;

public class PreviewTree implements TreeViewModel {
	// entity id -> kids
	// null -> collections
		...
		public void render(com.google.gwt.cell.client.Cell.Context context,
         ...
         public void onBrowserEvent(Context context, Element parent, JsEntity value,
           ...
           if ("click".equals(event.getType())) {
        	   if (type.equals("file")) {
        		   if(((JsFile) value).summary().endsWith(".xml"))
   					{
        			   XmlPopupPanel panel = new XmlPopupPanel(((JsFile) value).getSource());
        			   panel.show();
   					}
   			}
