...
public class EntityEditEvent extends Event<EntityEditEvent.Handler> {

    /**
     * Implemented by methods that handle MessageReceivedEvent events.
     */
    public interface Handler {
        void onMessageReceived(EntityEditEvent event);
    }
    ...
    public static HandlerRegistration register(EventBus eventBus,
    		EntityEditEvent.Handler handler) {
    ...
    public EntityEditEvent(JsDcp dcp, boolean setOpen, String sipPath) {
        this.dcp = dcp;
