...
public class DeliverableUnitEditor
    ...
    public DeliverableUnitEditor(String id,
                                 ...
                                 HashMap<String, ArrayList<String>> metadata) {
        this.id = id;
        this.coremd_editor = new CoreMetadataEditor(metadata);
        this.parents = new TextBox();
        this.location = new TextBox();
        this.pubdate = new TextBox();
        ...
        Util.addColumn(table, null, colchooser, parentchooser,location,pubdate, filechooser);
    ...
    public DeliverableUnit getDeliverableUnit() {
        ...
        du.setLocation(location.getText());
        du.setPubdate(pubdate.getText());
