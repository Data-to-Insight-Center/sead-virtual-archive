...
<!--
======================================================================
	FGDC CSDGM to ISO 19115-2 Transform using XPath 2.0 June 2012
...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:vmf="http://www.altova.com/MapForce/UDF/vmf" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:grp="http://www.altova.com/Mapforce/grouping" exclude-result-prefixes="fn grp vmf xs xsi xsl" xmlns="http://www.isotc211.org/2005/gmi">
	...
	<xsl:function name="grp:key09cbbfa0">
		<xsl:param name="cur"/>
		<xsl:for-each select="$cur/srcused">
			<xsl:sequence select="xs:string(.)"/>
		</xsl:for-each>
	</xsl:function>
	<xsl:function name="grp:key0eab6088">
		<xsl:param name="cur"/>
	...
	<xsl:template match="/">
		<gmi:MI_Metadata>
							...
							<gmd:lineage>
								<gmd:LI_Lineage>
									<xsl:for-each select="lineage/procstep">
										<xsl:variable name="var1688_procstep" as="node()" select="."/>
										<gmd:processStep>
											<gmd:LI_ProcessStep>
												<gmd:description>
													<gco:CharacterString>
												...
												<gmd:dateTime>
													...
													<xsl:variable name="var1691_cond_result_logicalor" as="xs:string?">
														<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(procdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(procdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(procdate))), 'present')))">
															<xsl:variable name="var1724_map_result_distinctvalues" as="xs:string*">
															...
															<xsl:variable name="var1723_map_result_distinctvalues" as="xs:string*">
																<xsl:for-each select="fn:distinct-values($var1724_map_result_distinctvalues)">
																	<xsl:variable name="var1729_cond_result_endswith" as="xs:string?">
																		<xsl:choose>
																			<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																				<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																					<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																	...
																	<xsl:if test="fn:exists($var1729_cond_result_endswith)">
																		<xsl:sequence select="$var1729_cond_result_endswith"/>
																	</xsl:if>
																</xsl:for-each>
															</xsl:variable>
															<xsl:if test="fn:exists($var1723_map_result_distinctvalues)">
																<xsl:sequence select="fn:string-join($var1723_map_result_distinctvalues, ' ')"/>
															</xsl:if>
														</xsl:if>
													</xsl:variable>
													<xsl:for-each select="$var1691_cond_result_logicalor">
														<xsl:variable name="var1692_cur_cond_result_logicalor" as="xs:string" select="."/>
														<xsl:variable name="var1694_map_select_proctime" as="xs:string?">
															<xsl:for-each select="$var1688_procstep/proctime">
																<xsl:variable name="var1721_result_vmf6_inputtoresult" as="xs:string?">
																	<xsl:call-template name="vmf:vmf6_inputtoresult">
																		<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																	</xsl:call-template>
																</xsl:variable>
																<xsl:variable name="var1720_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var1721_result_vmf6_inputtoresult)) then (if (fn:contains($var1721_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																<xsl:if test="not(fn:exists($var1720_cond_result_exists))">
																	<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																</xsl:if>
															</xsl:for-each>
														</xsl:variable>
														<xsl:for-each select="fn:distinct-values($var1694_map_select_proctime)">
															...
															<xsl:if test="fn:exists($var1699_cond_result_endswith)">
																<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith))), 'un'))">
																	<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith)))))) then 'T' else ()))">
																		<gco:DateTime>
																			<xsl:sequence select="xs:string(xs:dateTime(fn:string(fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var1692_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var1699_cond_result_endswith))))))))"/>
																		</gco:DateTime>
																	</xsl:if>
																</xsl:if>
															</xsl:if>
												...
												<xsl:for-each select="proccont">
													<xsl:variable name="var1736_proccont" as="node()" select="."/>
													<gmd:processor>
														<gmd:CI_ResponsibleParty>
															<gmd:individualName>
																<xsl:variable name="var1739_map_select_cntperp" as="xs:string?">
																	<xsl:for-each select="cntinfo/cntperp/cntper">
																		<xsl:sequence select="xs:string(.)"/>
																	</xsl:for-each>
																</xsl:variable>
																<xsl:variable name="var1738_cond_result_exists" as="xs:string?">
																	<xsl:choose>
																		<xsl:when test="fn:exists($var1739_map_select_cntperp)">
																			<xsl:for-each select="cntinfo/cntperp/cntper">
																				<xsl:sequence select="xs:string(.)"/>
																			</xsl:for-each>
																		</xsl:when>
																...
																<xsl:if test="fn:exists($var1738_cond_result_exists)">
																	<gco:CharacterString>
																		<xsl:sequence select="$var1738_cond_result_exists"/>
																	</gco:CharacterString>
																</xsl:if>
															</gmd:individualName>
															<gmd:organisationName>
																<xsl:variable name="var1748_map_select_cntperp" as="xs:string?">
																	<xsl:for-each select="cntinfo/cntperp/cntorg">
																		<xsl:sequence select="xs:string(.)"/>
																	</xsl:for-each>
																</xsl:variable>
																<xsl:variable name="var1747_cond_result_exists" as="xs:string?">
																	<xsl:choose>
																		<xsl:when test="fn:exists($var1748_map_select_cntperp)">
																			<xsl:for-each select="cntinfo/cntperp/cntorg">
																				<xsl:sequence select="xs:string(.)"/>
																			</xsl:for-each>
																		</xsl:when>
																...
																<xsl:if test="fn:exists($var1747_cond_result_exists)">
																	<gco:CharacterString>
																		<xsl:sequence select="$var1747_cond_result_exists"/>
																	</gco:CharacterString>
																</xsl:if>
															</gmd:organisationName>
															<gmd:positionName>
															...
															<gmd:contactInfo>
																<gmd:CI_Contact>
																	<gmd:phone>
																		<gmd:CI_Telephone>
																			<xsl:for-each-group select="cntinfo/cntvoice" group-by="fn:normalize-space(xs:string(.))">
																				<xsl:variable name="var1760_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
																				<gmd:voice>
																					<gco:CharacterString>
																						<xsl:sequence select="$var1760_cur_result_groupby"/>
																					</gco:CharacterString>
																				</gmd:voice>
																			</xsl:for-each-group>
																			<xsl:for-each-group select="cntinfo/cntfax" group-by="fn:normalize-space(xs:string(.))">
																				<xsl:variable name="var1764_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
																				<gmd:facsimile>
																					<gco:CharacterString>
																						<xsl:sequence select="$var1764_cur_result_groupby"/>
																					</gco:CharacterString>
																				</gmd:facsimile>
																			</xsl:for-each-group>
																		</gmd:CI_Telephone>
																	...
																	<xsl:for-each select="cntinfo/cntaddr">
																		<gmd:address>
																			<gmd:CI_Address>
																				<xsl:for-each-group select="address" group-by="fn:normalize-space(xs:string(.))">
																					<xsl:variable name="var1770_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
																					<gmd:deliveryPoint>
																						<gco:CharacterString>
																							<xsl:sequence select="$var1770_cur_result_groupby"/>
																						</gco:CharacterString>
																					</gmd:deliveryPoint>
																				</xsl:for-each-group>
																				<gmd:city>
																				...
																				<xsl:for-each-group select="$var1736_proccont/cntinfo/cntemail" group-by="fn:normalize-space(xs:string(.))">
																					<xsl:variable name="var1776_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
																					<gmd:electronicMailAddress>
																						<gco:CharacterString>
																							<xsl:sequence select="$var1776_cur_result_groupby"/>
																						</gco:CharacterString>
																					</gmd:electronicMailAddress>
																				</xsl:for-each-group>
																			</gmd:CI_Address>
															...
															<gmd:role>
																<xsl:variable name="var1804_map_select_cntperp" as="xs:string?">
																	<xsl:for-each select="cntinfo/cntperp/cntorg">
																		<xsl:sequence select="xs:string(.)"/>
																	</xsl:for-each>
																</xsl:variable>
																<xsl:variable name="var1803_cond_result_exists" as="xs:string?">
																	<xsl:choose>
																		<xsl:when test="fn:exists($var1804_map_select_cntperp)">
																			<xsl:for-each select="cntinfo/cntperp/cntorg">
																				<xsl:sequence select="xs:string(.)"/>
																			</xsl:for-each>
																		</xsl:when>
																...
																<xsl:variable name="var1782_cond_result_exists" as="xs:string?" select="(if (fn:exists($var1803_cond_result_exists)) then 'processor' else ())"/>
																<xsl:if test="fn:exists($var1782_cond_result_exists)">
																	<gmd:CI_RoleCode>
																		<xsl:variable name="var1785_map_select_cntperp" as="xs:string?">
																			<xsl:for-each select="cntinfo/cntperp/cntorg">
																				<xsl:sequence select="xs:string(.)"/>
																			</xsl:for-each>
																		</xsl:variable>
																		<xsl:variable name="var1784_cond_result_exists" as="xs:string?">
																			<xsl:choose>
																				<xsl:when test="fn:exists($var1785_map_select_cntperp)">
																					<xsl:for-each select="cntinfo/cntperp/cntorg">
																						<xsl:sequence select="xs:string(.)"/>
																					</xsl:for-each>
																				</xsl:when>
																		...
																		<xsl:variable name="var1783_cond_result_exists" as="xs:string?" select="(if (fn:exists($var1784_cond_result_exists)) then 'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_RoleCode' else ())"/>
																		<xsl:if test="fn:exists($var1783_cond_result_exists)">
																			<xsl:attribute name="codeList">
																				<xsl:sequence select="xs:string(xs:anyURI($var1783_cond_result_exists))"/>
																			</xsl:attribute>
																		</xsl:if>
																		<xsl:attribute name="codeListValue">
																			<xsl:sequence select="xs:string(xs:anyURI($var1782_cond_result_exists))"/>
																		</xsl:attribute>
																		<xsl:variable name="var1795_map_select_cntperp" as="xs:string?">
																			<xsl:for-each select="cntinfo/cntperp/cntorg">
																				<xsl:sequence select="xs:string(.)"/>
																			</xsl:for-each>
																		</xsl:variable>
																		<xsl:variable name="var1794_cond_result_exists" as="xs:string?">
																			<xsl:choose>
																				<xsl:when test="fn:exists($var1795_map_select_cntperp)">
																					<xsl:for-each select="cntinfo/cntperp/cntorg">
																						<xsl:sequence select="xs:string(.)"/>
																					</xsl:for-each>
																				</xsl:when>
																		...
																		<xsl:variable name="var1793_cond_result_exists" as="xs:string?" select="(if (fn:exists($var1794_cond_result_exists)) then '009' else ())"/>
																		<xsl:if test="fn:exists($var1793_cond_result_exists)">
																			<xsl:attribute name="codeSpace">
																				<xsl:sequence select="xs:string(xs:anyURI($var1793_cond_result_exists))"/>
																			</xsl:attribute>
																		</xsl:if>
																		<xsl:sequence select="$var1782_cond_result_exists"/>
																	</gmd:CI_RoleCode>
																</xsl:if>
															</gmd:role>
														</gmd:CI_ResponsibleParty>
												...
												<xsl:for-each-group select="." group-by="grp:key09cbbfa0(.)">
													<xsl:variable name="var1815_cur_result_groupby" as="item()+" select="current-group()"/>
													<xsl:variable name="var1816_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
													<gmd:source>
														<gmd:LI_Source>
															<gmd:sourceCitation>
																<gmd:CI_Citation>
																	<gmd:title>
																		<gco:CharacterString>
																			<xsl:sequence select="$var1816_cur_result_groupby"/>
																		</gco:CharacterString>
																	</gmd:title>
																	<xsl:for-each select="$var1815_cur_result_groupby/srcprod">
																		<gmd:alternateTitle>
																			<gco:CharacterString>
																				<xsl:sequence select="xs:string(.)"/>
																			</gco:CharacterString>
									...
									<xsl:for-each select="lineage/srcinfo">
										<xsl:variable name="var1820_srcinfo" as="node()" select="."/>
										<gmd:source>
											<gmd:LI_Source>
												<gmd:description>
													<gco:CharacterString>
												...
												<gmd:sourceCitation>
													<gmd:CI_Citation>
														...
														<gmd:date>
															<gmd:CI_Date>
																<gmd:date>
																	...
																	<xsl:variable name="var1827_cond_result_logicalor" as="xs:string?">
																		<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'present')))">
																			<xsl:variable name="var1832_map_result_distinctvalues" as="xs:string*">
																			...
																			<xsl:variable name="var1831_map_result_distinctvalues" as="xs:string*">
																				<xsl:for-each select="fn:distinct-values($var1832_map_result_distinctvalues)">
																					<xsl:variable name="var1837_cond_result_endswith" as="xs:string?">
																						<xsl:choose>
																							<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																								<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																									<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																					...
																					<xsl:if test="fn:exists($var1837_cond_result_endswith)">
																						<xsl:sequence select="$var1837_cond_result_endswith"/>
																					</xsl:if>
																				</xsl:for-each>
																			</xsl:variable>
																			<xsl:if test="fn:exists($var1831_map_result_distinctvalues)">
																				<xsl:sequence select="fn:string-join($var1831_map_result_distinctvalues, ' ')"/>
																			</xsl:if>
																		</xsl:if>
																	</xsl:variable>
																	<xsl:for-each select="$var1827_cond_result_logicalor">
																		<gco:Date>
																			<xsl:sequence select="xs:string(xs:string(fn:string(fn:normalize-space(.))))"/>
																		</gco:Date>
																	</xsl:for-each>
																	<xsl:variable name="var1845_cond_result_logicalor" as="xs:string?">
																		<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'present')))">
																			<xsl:variable name="var1878_map_result_distinctvalues" as="xs:string*">
																				<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(srccite/citeinfo/pubdate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																					<xsl:choose>
																						<xsl:when test="fn:ends-with(., '-')">
																							<xsl:if test="fn:ends-with(., '-')">
																			...
																			<xsl:variable name="var1877_map_result_distinctvalues" as="xs:string*">
																				<xsl:for-each select="fn:distinct-values($var1878_map_result_distinctvalues)">
																					<xsl:variable name="var1883_cond_result_endswith" as="xs:string?">
																						<xsl:choose>
																							<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																								<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																									<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																					...
																					<xsl:if test="fn:exists($var1883_cond_result_endswith)">
																						<xsl:sequence select="$var1883_cond_result_endswith"/>
																					</xsl:if>
																				</xsl:for-each>
																			</xsl:variable>
																			<xsl:if test="fn:exists($var1877_map_result_distinctvalues)">
																				<xsl:sequence select="fn:string-join($var1877_map_result_distinctvalues, ' ')"/>
																			</xsl:if>
																		</xsl:if>
																	</xsl:variable>
																	<xsl:for-each select="$var1845_cond_result_logicalor">
																		<xsl:variable name="var1846_cur_cond_result_logicalor" as="xs:string" select="."/>
																		<xsl:variable name="var1848_map_select_pubtime" as="xs:string?">
																			<xsl:for-each select="$var1820_srcinfo/srccite/citeinfo/pubtime">
																				<xsl:variable name="var1875_result_vmf6_inputtoresult" as="xs:string?">
																					<xsl:call-template name="vmf:vmf6_inputtoresult">
																						<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																					</xsl:call-template>
																				</xsl:variable>
																				<xsl:variable name="var1874_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var1875_result_vmf6_inputtoresult)) then (if (fn:contains($var1875_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																				<xsl:if test="not(fn:exists($var1874_cond_result_exists))">
																					<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																				</xsl:if>
																			</xsl:for-each>
																		</xsl:variable>
																		<xsl:for-each select="fn:distinct-values($var1848_map_select_pubtime)">
																			<xsl:variable name="var1853_cond_result_endswith" as="xs:string?">
																				<xsl:choose>
																					<xsl:when test="fn:ends-with(., ':')">
																						<xsl:if test="fn:ends-with(., ':')">
																							<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																			...
																			<xsl:if test="fn:exists($var1853_cond_result_endswith)">
																				<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith))), 'un'))">
																					<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith)))))) then 'T' else ()))">
																						<gco:DateTime>
																							<xsl:sequence select="xs:string(xs:dateTime(fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var1846_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var1853_cond_result_endswith)))))))"/>
																						</gco:DateTime>
																					</xsl:if>
																				</xsl:if>
																			</xsl:if>
														...
														<xsl:for-each-group select="srccite/citeinfo" group-by="grp:key0eab6088(.)">
															<xsl:variable name="var1896_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
															<gmd:citedResponsibleParty>
																<gmd:CI_ResponsibleParty>
																	<gmd:organisationName>
																		<gco:CharacterString>
																			<xsl:sequence select="$var1896_cur_result_groupby"/>
																		</gco:CharacterString>
																	</gmd:organisationName>
																	<gmd:role>
																		<gmd:CI_RoleCode>
														...
														<gmd:presentationForm>
															<xsl:variable name="var1898_cond_result_exists" as="xs:string?">
																<xsl:choose>
																	<xsl:when test="$var1820_srcinfo/srccite/citeinfo/geoform">
																		<xsl:for-each select="srccite/citeinfo/geoform">
																			<xsl:variable name="var1909_result_vmf7_inputtoresult" as="xs:string?">
																				<xsl:call-template name="vmf:vmf7_inputtoresult">
																					<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(xs:string(xs:string(.))))"/>
																				</xsl:call-template>
																			</xsl:variable>
																			<xsl:if test="fn:exists($var1909_result_vmf7_inputtoresult)">
																				<xsl:sequence select="$var1909_result_vmf7_inputtoresult"/>
																			</xsl:if>
																		</xsl:for-each>
																	</xsl:when>
																	<xsl:otherwise>
															...
															<xsl:if test="fn:exists($var1898_cond_result_exists)">
																<gmd:CI_PresentationFormCode>
																	<xsl:variable name="var1899_cond_result_exists" as="xs:string?" select="(if (fn:exists(srccite/citeinfo/geoform)) then 'http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#CI_PresentationFormCode' else ())"/>
																	<xsl:if test="fn:exists($var1899_cond_result_exists)">
																		<xsl:attribute name="codeList">
																			<xsl:sequence select="xs:string(xs:anyURI($var1899_cond_result_exists))"/>
																		</xsl:attribute>
																	</xsl:if>
																	<xsl:attribute name="codeListValue">
																		<xsl:sequence select="xs:string(xs:anyURI($var1898_cond_result_exists))"/>
																	</xsl:attribute>
																	<xsl:variable name="var1900_cond_result_exists" as="xs:string?">
																		<xsl:if test="$var1820_srcinfo/srccite/citeinfo/geoform">
																			<xsl:for-each select="srccite/citeinfo/geoform">
																				<xsl:variable name="var1904_result_vmf8_inputtoresult" as="xs:string?">
																					<xsl:call-template name="vmf:vmf8_inputtoresult">
																						<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(xs:string(xs:string(.))))"/>
																					</xsl:call-template>
																				</xsl:variable>
																				<xsl:if test="fn:exists($var1904_result_vmf8_inputtoresult)">
																					<xsl:sequence select="$var1904_result_vmf8_inputtoresult"/>
																				</xsl:if>
																			</xsl:for-each>
																		</xsl:if>
																	</xsl:variable>
																	...
																	<xsl:sequence select="$var1898_cond_result_exists"/>
																</gmd:CI_PresentationFormCode>
															</xsl:if>
														</gmd:presentationForm>
														<gmd:series>
												...
												<gmd:sourceExtent>
													<gmd:EX_Extent>
														<xsl:for-each select="srctime/timeinfo/sngdate">
															<xsl:variable name="var1918_sngdate" as="node()" select="."/>
															<gmd:temporalElement>
																<gmd:EX_TemporalExtent>
																	<gmd:extent>
																		<xsl:if test="(fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished'))">
																		...
																		<gml:TimeInstant>
																			...
																			<gml:description>
																				<xsl:sequence select="xs:string(xs:string($var1820_srcinfo/srctime/srccurr))"/>
																			</gml:description>
																			<xsl:variable name="var1991_cond_result_logicalor" as="xs:string?">
																				<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																					<xsl:variable name="var2024_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., '-')">
																									<xsl:if test="fn:ends-with(., '-')">
																					...
																					<xsl:variable name="var2023_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values($var2024_map_result_distinctvalues)">
																							<xsl:variable name="var2029_cond_result_endswith" as="xs:string?">
																								<xsl:choose>
																									<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																										<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																											<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																							...
																							<xsl:if test="fn:exists($var2029_cond_result_endswith)">
																								<xsl:sequence select="$var2029_cond_result_endswith"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:if test="fn:exists($var2023_map_result_distinctvalues)">
																						<xsl:sequence select="fn:string-join($var2023_map_result_distinctvalues, ' ')"/>
																					</xsl:if>
																				</xsl:if>
																			</xsl:variable>
																			<xsl:variable name="var1924_map_cond_result_logicalor" as="xs:string*">
																				<xsl:for-each select="$var1991_cond_result_logicalor">
																					<xsl:variable name="var1992_cur_cond_result_logicalor" as="xs:string" select="."/>
																					<xsl:variable name="var1994_map_select_time" as="xs:string?">
																						<xsl:for-each select="$var1918_sngdate/time">
																							<xsl:variable name="var2021_result_vmf6_inputtoresult" as="xs:string?">
																								<xsl:call-template name="vmf:vmf6_inputtoresult">
																									<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																								</xsl:call-template>
																							</xsl:variable>
																							<xsl:variable name="var2020_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2021_result_vmf6_inputtoresult)) then (if (fn:contains($var2021_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																							<xsl:if test="not(fn:exists($var2020_cond_result_exists))">
																								<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:for-each select="fn:distinct-values($var1994_map_select_time)">
																						<xsl:variable name="var1999_cond_result_endswith" as="xs:string?">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., ':')">
																									<xsl:if test="fn:ends-with(., ':')">
																										<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																						...
																						<xsl:if test="fn:exists($var1999_cond_result_endswith)">
																							<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith))), 'un'))">
																								<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith)))))) then 'T' else ()))">
																									<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var1992_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var1999_cond_result_endswith)))))"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:if>
																					</xsl:for-each>
																			...
																			<xsl:variable name="var1923_cond_result_exists" as="xs:string*">
																				<xsl:choose>
																					<xsl:when test="fn:exists($var1924_map_cond_result_logicalor)">
																						<xsl:variable name="var1927_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																								<xsl:variable name="var1960_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var1959_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var1960_map_result_distinctvalues)">
																										<xsl:variable name="var1965_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var1965_cond_result_endswith)">
																											<xsl:sequence select="$var1965_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var1959_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var1959_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var1927_cond_result_logicalor">
																							<xsl:variable name="var1928_cur_cond_result_logicalor" as="xs:string" select="."/>
																							<xsl:variable name="var1930_map_select_time" as="xs:string?">
																								<xsl:for-each select="$var1918_sngdate/time">
																									<xsl:variable name="var1957_result_vmf6_inputtoresult" as="xs:string?">
																										<xsl:call-template name="vmf:vmf6_inputtoresult">
																											<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																										</xsl:call-template>
																									</xsl:variable>
																									<xsl:variable name="var1956_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var1957_result_vmf6_inputtoresult)) then (if (fn:contains($var1957_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																									<xsl:if test="not(fn:exists($var1956_cond_result_exists))">
																										<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																									</xsl:if>
																								</xsl:for-each>
																							</xsl:variable>
																							<xsl:for-each select="fn:distinct-values($var1930_map_select_time)">
																								<xsl:variable name="var1935_cond_result_endswith" as="xs:string?">
																									<xsl:choose>
																										<xsl:when test="fn:ends-with(., ':')">
																											<xsl:if test="fn:ends-with(., ':')">
																												<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																								...
																								<xsl:if test="fn:exists($var1935_cond_result_endswith)">
																									<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith))), 'un'))">
																										<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith)))))) then 'T' else ()))">
																											<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var1928_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var1935_cond_result_endswith)))))"/>
																										</xsl:if>
																									</xsl:if>
																								</xsl:if>
																							</xsl:for-each>
																					...
																					<xsl:otherwise>
																						<xsl:variable name="var1973_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																								<xsl:variable name="var1978_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var1977_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var1978_map_result_distinctvalues)">
																										<xsl:variable name="var1983_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var1983_cond_result_endswith)">
																											<xsl:sequence select="$var1983_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var1977_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var1977_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var1973_cond_result_logicalor">
																							<xsl:sequence select="fn:string(fn:normalize-space(.))"/>
																						</xsl:for-each>
																					</xsl:otherwise>
																				</xsl:choose>
																			</xsl:variable>
																			<xsl:variable name="var1920_cond_result_exists" as="xs:string*" select="(if (fn:exists($var1923_cond_result_exists)) then $var1923_cond_result_exists else xs:string((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')) then fn:current-dateTime() else '')))"/>
																			<xsl:for-each select="$var1920_cond_result_exists">
																				<gml:timePosition>
																					<xsl:if test="fn:exists((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var1918_sngdate/caldate))), 'present')) then 'now' else ()))">
																						<xsl:attribute name="indeterminatePosition">
																							<xsl:sequence select="(if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var1918_sngdate/caldate))), 'present')) then 'now' else ())"/>
																						</xsl:attribute>
																					</xsl:if>
																					<xsl:sequence select="xs:string(xs:string(.))"/>
																				</gml:timePosition>
														...
														<xsl:for-each select="srctime/timeinfo/mdattim/sngdate">
															<xsl:variable name="var2036_sngdate" as="node()" select="."/>
															<gmd:temporalElement>
																<gmd:EX_TemporalExtent>
																	<gmd:extent>
																		<xsl:if test="(fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished'))">
																		...
																		<gml:TimeInstant>
																			...
																			<xsl:variable name="var2110_cond_result_logicalor" as="xs:string?">
																				<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																					<xsl:variable name="var2143_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., '-')">
																									<xsl:if test="fn:ends-with(., '-')">
																					...
																					<xsl:variable name="var2142_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values($var2143_map_result_distinctvalues)">
																							<xsl:variable name="var2148_cond_result_endswith" as="xs:string?">
																								<xsl:choose>
																									<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																										<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																											<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																							...
																							<xsl:if test="fn:exists($var2148_cond_result_endswith)">
																								<xsl:sequence select="$var2148_cond_result_endswith"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:if test="fn:exists($var2142_map_result_distinctvalues)">
																						<xsl:sequence select="fn:string-join($var2142_map_result_distinctvalues, ' ')"/>
																					</xsl:if>
																				</xsl:if>
																			</xsl:variable>
																			<xsl:variable name="var2043_map_cond_result_logicalor" as="xs:string*">
																				<xsl:for-each select="$var2110_cond_result_logicalor">
																					<xsl:variable name="var2111_cur_cond_result_logicalor" as="xs:string" select="."/>
																					<xsl:variable name="var2113_map_select_time" as="xs:string?">
																						<xsl:for-each select="$var2036_sngdate/time">
																							<xsl:variable name="var2140_result_vmf6_inputtoresult" as="xs:string?">
																								<xsl:call-template name="vmf:vmf6_inputtoresult">
																									<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																								</xsl:call-template>
																							</xsl:variable>
																							<xsl:variable name="var2139_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2140_result_vmf6_inputtoresult)) then (if (fn:contains($var2140_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																							<xsl:if test="not(fn:exists($var2139_cond_result_exists))">
																								<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:for-each select="fn:distinct-values($var2113_map_select_time)">
																						<xsl:variable name="var2118_cond_result_endswith" as="xs:string?">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., ':')">
																									<xsl:if test="fn:ends-with(., ':')">
																										<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																						...
																						<xsl:if test="fn:exists($var2118_cond_result_endswith)">
																							<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith))), 'un'))">
																								<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith)))))) then 'T' else ()))">
																									<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2111_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2118_cond_result_endswith)))))"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:if>
																					</xsl:for-each>
																			...
																			<xsl:variable name="var2042_cond_result_exists" as="xs:string*">
																				<xsl:choose>
																					<xsl:when test="fn:exists($var2043_map_cond_result_logicalor)">
																						<xsl:variable name="var2046_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																								<xsl:variable name="var2079_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var2078_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2079_map_result_distinctvalues)">
																										<xsl:variable name="var2084_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2084_cond_result_endswith)">
																											<xsl:sequence select="$var2084_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2078_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2078_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2046_cond_result_logicalor">
																							<xsl:variable name="var2047_cur_cond_result_logicalor" as="xs:string" select="."/>
																							<xsl:variable name="var2049_map_select_time" as="xs:string?">
																								<xsl:for-each select="$var2036_sngdate/time">
																									<xsl:variable name="var2076_result_vmf6_inputtoresult" as="xs:string?">
																										<xsl:call-template name="vmf:vmf6_inputtoresult">
																											<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																										</xsl:call-template>
																									</xsl:variable>
																									<xsl:variable name="var2075_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2076_result_vmf6_inputtoresult)) then (if (fn:contains($var2076_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																									<xsl:if test="not(fn:exists($var2075_cond_result_exists))">
																										<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																									</xsl:if>
																								</xsl:for-each>
																							</xsl:variable>
																							<xsl:for-each select="fn:distinct-values($var2049_map_select_time)">
																								<xsl:variable name="var2054_cond_result_endswith" as="xs:string?">
																									<xsl:choose>
																										<xsl:when test="fn:ends-with(., ':')">
																											<xsl:if test="fn:ends-with(., ':')">
																												<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																								...
																								<xsl:if test="fn:exists($var2054_cond_result_endswith)">
																									<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith))), 'un'))">
																										<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith)))))) then 'T' else ()))">
																											<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2047_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2054_cond_result_endswith)))))"/>
																										</xsl:if>
																									</xsl:if>
																								</xsl:if>
																							</xsl:for-each>
																					...
																					<xsl:otherwise>
																						<xsl:variable name="var2092_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')))">
																								<xsl:variable name="var2097_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(caldate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var2096_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2097_map_result_distinctvalues)">
																										<xsl:variable name="var2102_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2102_cond_result_endswith)">
																											<xsl:sequence select="$var2102_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2096_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2096_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2092_cond_result_logicalor">
																							<xsl:sequence select="fn:string(fn:normalize-space(.))"/>
																						</xsl:for-each>
																					</xsl:otherwise>
																				</xsl:choose>
																			</xsl:variable>
																			<xsl:variable name="var2038_cond_result_exists" as="xs:string*" select="(if (fn:exists($var2042_cond_result_exists)) then $var2042_cond_result_exists else xs:string((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string(caldate))), 'present')) then fn:current-dateTime() else '')))"/>
																			<xsl:for-each select="$var2038_cond_result_exists">
																				<gml:timePosition>
																					<xsl:variable name="var2041_cond_result_exists" as="xs:string?" select="(if (fn:exists((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2036_sngdate/caldate))), 'present')) then 'now' else ()))) then (if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2036_sngdate/caldate))), 'present')) then 'now' else ()) else 'unknown')"/>
																					<xsl:if test="fn:exists($var2041_cond_result_exists)">
																						<xsl:attribute name="indeterminatePosition">
																							<xsl:sequence select="$var2041_cond_result_exists"/>
																						</xsl:attribute>
																					</xsl:if>
																					<xsl:sequence select="xs:string(xs:string(.))"/>
																				</gml:timePosition>
														...
														<xsl:for-each select="srctime/timeinfo/rngdates">
															<xsl:variable name="var2155_rngdates" as="node()" select="."/>
															<gmd:temporalElement>
																<gmd:EX_TemporalExtent>
																	<gmd:extent>
																		<xsl:if test="(fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished'))">
																		...
																		<gml:TimePeriod>
																			...
																			<xsl:variable name="var2228_cond_result_logicalor" as="xs:string?">
																				<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present')))">
																					<xsl:variable name="var2261_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., '-')">
																									<xsl:if test="fn:ends-with(., '-')">
																					...
																					<xsl:variable name="var2260_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values($var2261_map_result_distinctvalues)">
																							<xsl:variable name="var2266_cond_result_endswith" as="xs:string?">
																								<xsl:choose>
																									<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																										<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																											<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																							...
																							<xsl:if test="fn:exists($var2266_cond_result_endswith)">
																								<xsl:sequence select="$var2266_cond_result_endswith"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:if test="fn:exists($var2260_map_result_distinctvalues)">
																						<xsl:sequence select="fn:string-join($var2260_map_result_distinctvalues, ' ')"/>
																					</xsl:if>
																				</xsl:if>
																			</xsl:variable>
																			<xsl:variable name="var2161_map_cond_result_logicalor" as="xs:string*">
																				<xsl:for-each select="$var2228_cond_result_logicalor">
																					<xsl:variable name="var2229_cur_cond_result_logicalor" as="xs:string" select="."/>
																					<xsl:variable name="var2231_map_select_begtime" as="xs:string?">
																						<xsl:for-each select="$var2155_rngdates/begtime">
																							<xsl:variable name="var2258_result_vmf6_inputtoresult" as="xs:string?">
																								<xsl:call-template name="vmf:vmf6_inputtoresult">
																									<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																								</xsl:call-template>
																							</xsl:variable>
																							<xsl:variable name="var2257_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2258_result_vmf6_inputtoresult)) then (if (fn:contains($var2258_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																							<xsl:if test="not(fn:exists($var2257_cond_result_exists))">
																								<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:for-each select="fn:distinct-values($var2231_map_select_begtime)">
																						<xsl:variable name="var2236_cond_result_endswith" as="xs:string?">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., ':')">
																									<xsl:if test="fn:ends-with(., ':')">
																										<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																						...
																						<xsl:if test="fn:exists($var2236_cond_result_endswith)">
																							<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith))), 'un'))">
																								<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith)))))) then 'T' else ()))">
																									<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2229_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2236_cond_result_endswith)))))"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:if>
																					</xsl:for-each>
																			...
																			<xsl:variable name="var2160_cond_result_exists" as="xs:string*">
																				<xsl:choose>
																					<xsl:when test="fn:exists($var2161_map_cond_result_logicalor)">
																						<xsl:variable name="var2164_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present')))">
																								<xsl:variable name="var2197_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var2196_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2197_map_result_distinctvalues)">
																										<xsl:variable name="var2202_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2202_cond_result_endswith)">
																											<xsl:sequence select="$var2202_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2196_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2196_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2164_cond_result_logicalor">
																							<xsl:variable name="var2165_cur_cond_result_logicalor" as="xs:string" select="."/>
																							<xsl:variable name="var2167_map_select_begtime" as="xs:string?">
																								<xsl:for-each select="$var2155_rngdates/begtime">
																									<xsl:variable name="var2194_result_vmf6_inputtoresult" as="xs:string?">
																										<xsl:call-template name="vmf:vmf6_inputtoresult">
																											<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																										</xsl:call-template>
																									</xsl:variable>
																									<xsl:variable name="var2193_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2194_result_vmf6_inputtoresult)) then (if (fn:contains($var2194_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																									<xsl:if test="not(fn:exists($var2193_cond_result_exists))">
																										<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																									</xsl:if>
																								</xsl:for-each>
																							</xsl:variable>
																							<xsl:for-each select="fn:distinct-values($var2167_map_select_begtime)">
																								<xsl:variable name="var2172_cond_result_endswith" as="xs:string?">
																									<xsl:choose>
																										<xsl:when test="fn:ends-with(., ':')">
																											<xsl:if test="fn:ends-with(., ':')">
																												<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																								...
																								<xsl:if test="fn:exists($var2172_cond_result_endswith)">
																									<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith))), 'un'))">
																										<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith)))))) then 'T' else ()))">
																											<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2165_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2172_cond_result_endswith)))))"/>
																										</xsl:if>
																									</xsl:if>
																								</xsl:if>
																							</xsl:for-each>
																					...
																					<xsl:otherwise>
																						<xsl:variable name="var2210_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present')))">
																								<xsl:variable name="var2215_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(begdate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var2214_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2215_map_result_distinctvalues)">
																										<xsl:variable name="var2220_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2220_cond_result_endswith)">
																											<xsl:sequence select="$var2220_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2214_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2214_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2210_cond_result_logicalor">
																							<xsl:sequence select="fn:string(fn:normalize-space(.))"/>
																						</xsl:for-each>
																					</xsl:otherwise>
																				</xsl:choose>
																			</xsl:variable>
																			<xsl:variable name="var2157_cond_result_exists" as="xs:string*" select="(if (fn:exists($var2160_cond_result_exists)) then $var2160_cond_result_exists else xs:string((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string(begdate))), 'present')) then fn:current-dateTime() else '')))"/>
																			<xsl:for-each select="$var2157_cond_result_exists">
																				<gml:beginPosition>
																					<xsl:if test="fn:exists((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2155_rngdates/begdate))), 'present')) then 'now' else ()))">
																						<xsl:attribute name="indeterminatePosition">
																							<xsl:sequence select="(if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2155_rngdates/begdate))), 'present')) then 'now' else ())"/>
																						</xsl:attribute>
																					</xsl:if>
																					<xsl:sequence select="xs:string(xs:string(.))"/>
																				</gml:beginPosition>
																			</xsl:for-each>
																			<xsl:variable name="var2344_cond_result_logicalor" as="xs:string?">
																				<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present')))">
																					<xsl:variable name="var2377_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., '-')">
																									<xsl:if test="fn:ends-with(., '-')">
																					...
																					<xsl:variable name="var2376_map_result_distinctvalues" as="xs:string*">
																						<xsl:for-each select="fn:distinct-values($var2377_map_result_distinctvalues)">
																							<xsl:variable name="var2382_cond_result_endswith" as="xs:string?">
																								<xsl:choose>
																									<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																										<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																											<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																							...
																							<xsl:if test="fn:exists($var2382_cond_result_endswith)">
																								<xsl:sequence select="$var2382_cond_result_endswith"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:if test="fn:exists($var2376_map_result_distinctvalues)">
																						<xsl:sequence select="fn:string-join($var2376_map_result_distinctvalues, ' ')"/>
																					</xsl:if>
																				</xsl:if>
																			</xsl:variable>
																			<xsl:variable name="var2277_map_cond_result_logicalor" as="xs:string*">
																				<xsl:for-each select="$var2344_cond_result_logicalor">
																					<xsl:variable name="var2345_cur_cond_result_logicalor" as="xs:string" select="."/>
																					<xsl:variable name="var2347_map_select_endtime" as="xs:string?">
																						<xsl:for-each select="$var2155_rngdates/endtime">
																							<xsl:variable name="var2374_result_vmf6_inputtoresult" as="xs:string?">
																								<xsl:call-template name="vmf:vmf6_inputtoresult">
																									<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																								</xsl:call-template>
																							</xsl:variable>
																							<xsl:variable name="var2373_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2374_result_vmf6_inputtoresult)) then (if (fn:contains($var2374_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																							<xsl:if test="not(fn:exists($var2373_cond_result_exists))">
																								<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																							</xsl:if>
																						</xsl:for-each>
																					</xsl:variable>
																					<xsl:for-each select="fn:distinct-values($var2347_map_select_endtime)">
																						<xsl:variable name="var2352_cond_result_endswith" as="xs:string?">
																							<xsl:choose>
																								<xsl:when test="fn:ends-with(., ':')">
																									<xsl:if test="fn:ends-with(., ':')">
																										<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																						...
																						<xsl:if test="fn:exists($var2352_cond_result_endswith)">
																							<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith))), 'un'))">
																								<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith)))))) then 'T' else ()))">
																									<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2345_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2352_cond_result_endswith)))))"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:if>
																					</xsl:for-each>
																			...
																			<xsl:variable name="var2276_cond_result_exists" as="xs:string*">
																				<xsl:choose>
																					<xsl:when test="fn:exists($var2277_map_cond_result_logicalor)">
																						<xsl:variable name="var2280_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present')))">
																								...
																								<xsl:variable name="var2312_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2313_map_result_distinctvalues)">
																										<xsl:variable name="var2318_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2318_cond_result_endswith)">
																											<xsl:sequence select="$var2318_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2312_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2312_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2280_cond_result_logicalor">
																							<xsl:variable name="var2281_cur_cond_result_logicalor" as="xs:string" select="."/>
																							<xsl:variable name="var2283_map_select_endtime" as="xs:string?">
																								<xsl:for-each select="$var2155_rngdates/endtime">
																									<xsl:variable name="var2310_result_vmf6_inputtoresult" as="xs:string?">
																										<xsl:call-template name="vmf:vmf6_inputtoresult">
																											<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(fn:string(.)))"/>
																										</xsl:call-template>
																									</xsl:variable>
																									<xsl:variable name="var2309_cond_result_exists" as="xs:boolean?" select="(if (fn:exists($var2310_result_vmf6_inputtoresult)) then (if (fn:contains($var2310_result_vmf6_inputtoresult, 'unknown')) then fn:true() else ()) else ())"/>
																									<xsl:if test="not(fn:exists($var2309_cond_result_exists))">
																										<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(0)), xs:double(xs:decimal(3))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double(xs:decimal(3)), xs:double(xs:decimal(2)))), ':'), fn:substring(fn:normalize-space(fn:string(.)), xs:double('5'), xs:double(xs:decimal(2)))))"/>
																									</xsl:if>
																								</xsl:for-each>
																							</xsl:variable>
																							<xsl:for-each select="fn:distinct-values($var2283_map_select_endtime)">
																								<xsl:variable name="var2288_cond_result_endswith" as="xs:string?">
																									<xsl:choose>
																										<xsl:when test="fn:ends-with(., ':')">
																											<xsl:if test="fn:ends-with(., ':')">
																												<xsl:if test="fn:exists((if (((('0' != .) and ('false' != .)) and fn:boolean(.))) then fn:substring(., xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(.)) - xs:decimal(0)))) else ()))">
																								...
																								<xsl:if test="fn:exists($var2288_cond_result_endswith)">
																									<xsl:if test="not(fn:contains(fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith))), 'un'))">
																										<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith)))))) then 'T' else ()))">
																											<xsl:sequence select="fn:string(fn:concat(fn:concat(fn:normalize-space(fn:string(fn:normalize-space($var2281_cur_cond_result_logicalor))), (if (((('0' != fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith)))) and ('false' != fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith))))) and fn:boolean(fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith)))))) then 'T' else ())), fn:normalize-space(fn:lower-case(fn:string($var2288_cond_result_endswith)))))"/>
																										</xsl:if>
																									</xsl:if>
																								</xsl:if>
																							</xsl:for-each>
																					...
																					<xsl:otherwise>
																						<xsl:variable name="var2326_cond_result_logicalor" as="xs:string?">
																							<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present')))">
																								<xsl:variable name="var2331_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values((if (((fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present'))) then () else fn:concat(fn:concat(fn:concat(fn:concat(fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(0)), xs:double(xs:decimal(5))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(5)), xs:double(xs:decimal(2)))), '-'), fn:substring(fn:lower-case(fn:normalize-space(fn:string(enddate))), xs:double(xs:decimal(7)), xs:double(xs:decimal(2))))))">
																										<xsl:choose>
																											<xsl:when test="fn:ends-with(., '-')">
																												<xsl:if test="fn:ends-with(., '-')">
																								...
																								<xsl:variable name="var2330_map_result_distinctvalues" as="xs:string*">
																									<xsl:for-each select="fn:distinct-values($var2331_map_result_distinctvalues)">
																										<xsl:variable name="var2336_cond_result_endswith" as="xs:string?">
																											<xsl:choose>
																												<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																													<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																														<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
																										...
																										<xsl:if test="fn:exists($var2336_cond_result_endswith)">
																											<xsl:sequence select="$var2336_cond_result_endswith"/>
																										</xsl:if>
																									</xsl:for-each>
																								</xsl:variable>
																								<xsl:if test="fn:exists($var2330_map_result_distinctvalues)">
																									<xsl:sequence select="fn:string-join($var2330_map_result_distinctvalues, ' ')"/>
																								</xsl:if>
																							</xsl:if>
																						</xsl:variable>
																						<xsl:for-each select="$var2326_cond_result_logicalor">
																							<xsl:sequence select="fn:string(fn:normalize-space(.))"/>
																						</xsl:for-each>
																					</xsl:otherwise>
																				</xsl:choose>
																			</xsl:variable>
																			<xsl:variable name="var2273_cond_result_exists" as="xs:string*" select="(if (fn:exists($var2276_cond_result_exists)) then $var2276_cond_result_exists else xs:string((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string(enddate))), 'present')) then fn:current-dateTime() else '')))"/>
																			<xsl:for-each select="$var2273_cond_result_exists">
																				<gml:endPosition>
																					<xsl:if test="fn:exists((if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2155_rngdates/enddate))), 'present')) then 'now' else ()))">
																						<xsl:attribute name="indeterminatePosition">
																							<xsl:sequence select="(if (fn:contains(fn:lower-case(fn:normalize-space(fn:string($var2155_rngdates/enddate))), 'present')) then 'now' else ())"/>
																						</xsl:attribute>
																					</xsl:if>
																					<xsl:sequence select="xs:string(xs:string(.))"/>
																				</gml:endPosition>
			...
			<xsl:for-each select="$var1_instance/metadata">
				<xsl:variable name="var2389_metadata" as="node()" select="."/>
				<xsl:for-each select="metainfo/metac">
					<gmd:metadataConstraints>
						<gmd:MD_LegalConstraints>
							...
							<gmd:useConstraints>
								<gmd:MD_RestrictionCode>
									<xsl:if test="$var2389_metadata/metainfo/metuc">
										<xsl:attribute name="codeList">
											<xsl:sequence select="xs:string(xs:anyURI('http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_RestrictionCode'))"/>
										</xsl:attribute>
									</xsl:if>
							...
							<gmd:otherConstraints>
								<xsl:variable name="var2393_cond_result_exists" as="xs:string?">
									<xsl:choose>
										<xsl:when test="$var2389_metadata/metainfo/metuc">
											<xsl:for-each select="$var2389_metadata/metainfo/metuc">
												<xsl:sequence select="xs:string(.)"/>
											</xsl:for-each>
										</xsl:when>
										<xsl:otherwise>
								...
								<xsl:if test="fn:exists($var2393_cond_result_exists)">
									<gco:CharacterString>
										<xsl:variable name="var2394_cond_result_exists" as="xs:string" select="(if (fn:exists($var2389_metadata/metainfo/metuc)) then ' Metadata Use Constraints: ' else ' ')"/>
										<xsl:sequence select="fn:normalize-space(fn:concat(fn:concat(fn:concat('Metadata Access Constraints: ', xs:string(.)), $var2394_cond_result_exists), $var2393_cond_result_exists))"/>
									</gco:CharacterString>
								</xsl:if>
							</gmd:otherConstraints>
						</gmd:MD_LegalConstraints>
			...
			<xsl:for-each select="$var1_instance/metadata/metainfo/metsi">
				<gmd:metadataConstraints>
					<gmd:MD_SecurityConstraints>
						<gmd:classification>
							<gmd:MD_ClassificationCode>
								<xsl:variable name="var2401_result_vmf13_inputtoresult" as="xs:string?">
									<xsl:call-template name="vmf:vmf13_inputtoresult">
										<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(xs:string(xs:string(metsc))))"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:variable name="var2400_cond_result_exists" as="xs:string?" select="(if (fn:exists($var2401_result_vmf13_inputtoresult)) then $var2401_result_vmf13_inputtoresult else ())"/>
								<xsl:if test="fn:exists($var2400_cond_result_exists)">
									<xsl:attribute name="codeList">
										<xsl:sequence select="xs:string(xs:anyURI($var2400_cond_result_exists))"/>
									</xsl:attribute>
								</xsl:if>
								<xsl:attribute name="codeListValue">
									<xsl:sequence select="xs:string(xs:anyURI('http://www.isotc211.org/2005/resources/Codelist/gmxCodelists.xml#MD_ClassificationCode'))"/>
								</xsl:attribute>
								<xsl:variable name="var2403_result_vmf14_inputtoresult" as="xs:string?">
									<xsl:call-template name="vmf:vmf14_inputtoresult">
										<xsl:with-param name="input" select="fn:upper-case(fn:normalize-space(xs:string(xs:string(metsc))))"/>
									</xsl:call-template>
								</xsl:variable>
								<xsl:variable name="var2402_cond_result_exists" as="xs:string?" select="(if (fn:exists($var2403_result_vmf14_inputtoresult)) then $var2403_result_vmf14_inputtoresult else ())"/>
				...
				<gmd:MD_MaintenanceInformation>
					...
					<xsl:for-each select="$var1_instance/metadata/metainfo/metfrd">
						<gmd:dateOfNextUpdate>
							...
							<xsl:variable name="var2407_cond_result_logicalor" as="xs:string?">
								<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(xs:string(.)))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(xs:string(.)))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(xs:string(.)))), 'present')))">
									<xsl:variable name="var2412_map_result_distinctvalues" as="xs:string*">
									...
									<xsl:variable name="var2411_map_result_distinctvalues" as="xs:string*">
										<xsl:for-each select="fn:distinct-values($var2412_map_result_distinctvalues)">
											<xsl:variable name="var2417_cond_result_endswith" as="xs:string?">
												<xsl:choose>
													<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
														<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
															<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
											...
											<xsl:if test="fn:exists($var2417_cond_result_endswith)">
												<xsl:sequence select="$var2417_cond_result_endswith"/>
											</xsl:if>
										</xsl:for-each>
									</xsl:variable>
									<xsl:if test="fn:exists($var2411_map_result_distinctvalues)">
										<xsl:sequence select="fn:string-join($var2411_map_result_distinctvalues, ' ')"/>
									</xsl:if>
								</xsl:if>
							</xsl:variable>
							<xsl:for-each select="$var2407_cond_result_logicalor">
								<gco:Date>
									<xsl:sequence select="xs:string(xs:string(fn:string(fn:normalize-space(.))))"/>
								</gco:Date>
							</xsl:for-each>
					...
					<gmd:maintenanceNote>
						<xsl:for-each select="$var1_instance/metadata">
							<xsl:variable name="var2428_map_select_metadata" as="xs:string?">
								<xsl:for-each select="$var1_instance/metadata/metainfo/metrd">
									<xsl:variable name="var2432_cond_result_logicalor" as="xs:string?">
										<xsl:if test="not(((fn:contains(fn:lower-case(fn:normalize-space(fn:string(.))), 'unknown') or fn:contains(fn:lower-case(fn:normalize-space(fn:string(.))), 'unpublished')) or fn:contains(fn:lower-case(fn:normalize-space(fn:string(.))), 'present')))">
											<xsl:variable name="var2437_map_result_distinctvalues" as="xs:string*">
											...
											<xsl:variable name="var2436_map_result_distinctvalues" as="xs:string*">
												<xsl:for-each select="fn:distinct-values($var2437_map_result_distinctvalues)">
													<xsl:variable name="var2442_cond_result_endswith" as="xs:string?">
														<xsl:choose>
															<xsl:when test="fn:ends-with(fn:normalize-space(.), '-')">
																<xsl:if test="fn:ends-with(fn:normalize-space(.), '-')">
																	<xsl:if test="fn:exists((if (((('0' != fn:normalize-space(.)) and ('false' != fn:normalize-space(.))) and fn:boolean(fn:normalize-space(.)))) then fn:substring(fn:normalize-space(.), xs:double(xs:decimal(0)), xs:double((xs:decimal(fn:string-length(fn:normalize-space(.))) - xs:decimal(0)))) else ()))">
													...
													<xsl:if test="fn:exists($var2442_cond_result_endswith)">
														<xsl:sequence select="$var2442_cond_result_endswith"/>
													</xsl:if>
												</xsl:for-each>
											</xsl:variable>
											<xsl:if test="fn:exists($var2436_map_result_distinctvalues)">
												<xsl:sequence select="fn:string-join($var2436_map_result_distinctvalues, ' ')"/>
											</xsl:if>
										</xsl:if>
									</xsl:variable>
									<xsl:for-each select="$var2432_cond_result_logicalor">
										<xsl:sequence select="fn:string(fn:normalize-space(.))"/>
									</xsl:for-each>
								</xsl:for-each>
							</xsl:variable>
							<xsl:variable name="var2426_cond_result_exists" as="xs:string?" select="(if (fn:exists($var2428_map_select_metadata)) then $var2428_map_select_metadata else ' ')"/>
							<xsl:if test="fn:exists($var2426_cond_result_exists)">
								<gco:CharacterString>
									<xsl:variable name="var2427_cond_result_exists" as="xs:string" select="(if (fn:exists($var1_instance/metadata/metainfo/metrd)) then ' Metadata Review Date: ' else ' ')"/>
									<xsl:sequence select="fn:normalize-space(fn:string(fn:concat(fn:concat(fn:concat(fn:concat(fn:concat(fn:concat('This metadata was automatically generated from the ', xs:string(xs:string(metainfo/metstdn))), 'standard version '), xs:string(metainfo/metstdv)), ' using the June 2012 version of the FGDC CSDGM to ISO 19115-2 transform.'), $var2427_cond_result_exists), $var2426_cond_result_exists)))"/>
								</gco:CharacterString>
							</xsl:if>
						</xsl:for-each>
					</gmd:maintenanceNote>
					<gmd:contact>
						<gmd:CI_ResponsibleParty>
							<gmd:individualName>
								<xsl:variable name="var2450_map_select_metadata" as="xs:string?">
									<xsl:for-each select="$var1_instance/metadata/metainfo/metc/cntinfo/cntperp/cntper">
										<xsl:sequence select="xs:string(.)"/>
									</xsl:for-each>
								</xsl:variable>
								<xsl:variable name="var2449_cond_result_exists" as="xs:string?">
									<xsl:choose>
										<xsl:when test="fn:exists($var2450_map_select_metadata)">
											<xsl:for-each select="$var1_instance/metadata/metainfo/metc/cntinfo/cntperp/cntper">
												<xsl:sequence select="xs:string(.)"/>
											</xsl:for-each>
										</xsl:when>
								...
								<xsl:if test="fn:exists($var2449_cond_result_exists)">
									<gco:CharacterString>
										<xsl:sequence select="fn:normalize-space($var2449_cond_result_exists)"/>
									</gco:CharacterString>
								</xsl:if>
							</gmd:individualName>
							<gmd:organisationName>
								<xsl:variable name="var2459_map_select_metadata" as="xs:string?">
									<xsl:for-each select="$var1_instance/metadata/metainfo/metc/cntinfo/cntperp/cntorg">
										<xsl:sequence select="xs:string(.)"/>
									</xsl:for-each>
								</xsl:variable>
								<xsl:variable name="var2458_cond_result_exists" as="xs:string?">
									<xsl:choose>
										<xsl:when test="fn:exists($var2459_map_select_metadata)">
											<xsl:for-each select="$var1_instance/metadata/metainfo/metc/cntinfo/cntperp/cntorg">
												<xsl:sequence select="xs:string(.)"/>
											</xsl:for-each>
										</xsl:when>
								...
								<xsl:if test="fn:exists($var2458_cond_result_exists)">
									<gco:CharacterString>
										<xsl:sequence select="fn:normalize-space($var2458_cond_result_exists)"/>
									</gco:CharacterString>
								</xsl:if>
							</gmd:organisationName>
							<xsl:for-each select="$var1_instance/metadata/metainfo/metc/cntinfo/cntpos">
							...
							<gmd:contactInfo>
								<gmd:CI_Contact>
									<gmd:phone>
										<gmd:CI_Telephone>
											<xsl:for-each-group select="$var1_instance/metadata/metainfo/metc/cntinfo/cntvoice" group-by="fn:normalize-space(xs:string(.))">
												<xsl:variable name="var2471_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
												<gmd:voice>
													<gco:CharacterString>
														<xsl:sequence select="$var2471_cur_result_groupby"/>
													</gco:CharacterString>
												</gmd:voice>
											</xsl:for-each-group>
											<xsl:for-each-group select="$var1_instance/metadata/metainfo/metc/cntinfo/cntfax" group-by="fn:normalize-space(xs:string(.))">
												<xsl:variable name="var2475_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
												<gmd:facsimile>
													<gco:CharacterString>
														<xsl:sequence select="$var2475_cur_result_groupby"/>
													</gco:CharacterString>
												</gmd:facsimile>
											</xsl:for-each-group>
										</gmd:CI_Telephone>
									...
									<xsl:for-each select="$var1_instance/metadata">
										<xsl:variable name="var2477_metadata" as="node()" select="."/>
										<xsl:for-each select="metainfo/metc/cntinfo/cntaddr">
											<gmd:address>
												<gmd:CI_Address>
													<xsl:for-each-group select="address" group-by="fn:normalize-space(xs:string(.))">
														<xsl:variable name="var2483_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
														<gmd:deliveryPoint>
															<gco:CharacterString>
																<xsl:sequence select="$var2483_cur_result_groupby"/>
															</gco:CharacterString>
														</gmd:deliveryPoint>
													</xsl:for-each-group>
													<gmd:city>
													...
													<xsl:for-each-group select="$var2477_metadata/metainfo/metc/cntinfo/cntemail" group-by="fn:normalize-space(xs:string(.))">
														<xsl:variable name="var2489_cur_result_groupby" as="xs:string" select="current-grouping-key()"/>
														<gmd:electronicMailAddress>
															<gco:CharacterString>
																<xsl:sequence select="$var2489_cur_result_groupby"/>
															</gco:CharacterString>
														</gmd:electronicMailAddress>
													</xsl:for-each-group>
												</gmd:CI_Address>
