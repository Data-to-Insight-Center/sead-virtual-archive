...
public final class GoogleAuthHelper {
    ...
    private static final String USER_EMAIL_URL = "https://www.googleapis.com/oauth2/v1/userinfo.email";
	...
	public Userinfo getUserInfo(final String accessToken) throws IOException {
        ...
        scopes.add(USER_INFO_URL);
        scopes.add(USER_EMAIL_URL);

		Credential credential = new GoogleCredential.Builder().setServiceAccountScopes(scopes).build();
