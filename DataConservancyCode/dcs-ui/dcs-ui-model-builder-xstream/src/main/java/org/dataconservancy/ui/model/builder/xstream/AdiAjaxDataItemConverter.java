 ...
 * objects that serializes files as a list, not a single object.
 */
public class AdiAjaxDataItemConverter
    ...
    public AdiAjaxDataItemConverter() {
    }
        ...
        if (dataItemSource != null) {
            ...
            if (fileList != null && !fileList.isEmpty()) {
                ...
                for (DataFile dataFile : fileList) {
                    writer.startNode(AdiAjaxDataItemConverter.E_FILE);
    ...
    public Object unmarshal(HierarchicalStreamReader reader,
        ...
        while (reader.hasMoreChildren()) {
            ...
            if (ename.equals(E_NAME)) {
                ...
                while (reader.hasMoreChildren()) {
                    reader.moveDown();
                    if (getElementName(reader).equals(AdiAjaxDataItemConverter.E_FILE)) {
                        dataFile =
                                (DataFile) context
