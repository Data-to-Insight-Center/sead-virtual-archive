...
@ContextConfiguration({"classpath*:/org/dataconservancy/ui/config/test-applicationContext.xml", "classpath:/org/dataconservancy/ui/config/applicationContext.xml"})
public abstract class BaseUnitTest {
    ...
    protected RegistrationStatus defaultRegistrationStatus;

    protected PersonName creatorOne;

    protected PersonName creatorTwo;
    
    protected DropboxModel dropboxModel;
    ...
    public final void baseSetup() throws IOException {
        ...
        java.io.File metadataTmp =
                java.io.File.createTempFile("testMetadataFile", null);
        ...
        metadataFileTwo.setId("id:MetadataFileOne");
        ...
        dropboxModel.setClientMtime(DateTime.now());
        dropboxModel.setContents(null);
        dropboxModel.setDeleted(false);
        dropboxModel.setDir(false);
        dropboxModel.setFileSize(1235);
        dropboxModel.setHash("askjash2389283lskja");
        ...
        Resource r = new UrlResource(dataFileOne.getSource());
        ...
        newUser.setRegistrationStatus(defaultRegistrationStatus);
