...
public class ApproveRegistrationRequest {
    ...
    private static final String STRIPES_EVENT = "approveRegistrations";

    private final UiUrlConfig config;

    private String emailAddress;

    public ApproveRegistrationRequest(UiUrlConfig config) {
        this.config = config;
    }

    public ApproveRegistrationRequest(UiUrlConfig config, String emailAddress) {
        this.config = config;
