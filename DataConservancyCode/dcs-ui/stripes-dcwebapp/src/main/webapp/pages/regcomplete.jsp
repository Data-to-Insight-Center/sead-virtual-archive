...
<stripes:layout-render name="/layout/${requestScope['stripes_layout']}/layout.jsp">
    <stripes:layout-component name="pageTitle">
        <fmt_rt:bundle basename="StripesResources" prefix="${actionBean.class.name}.">
            <fmt:message key="successTitle"/>
        </fmt_rt:bundle>
    </stripes:layout-component>
    <stripes:layout-component name="contents">
        <p>
            <fmt_rt:bundle basename="StripesResources" prefix="dataConservancyInstance.">
                <fmt:message key="name" var="instanceName"/>
            </fmt_rt:bundle>
            <fmt_rt:bundle basename="StripesResources" prefix="${actionBean.class.name}.">
                <fmt:message key="success">
                    <fmt:param  value="${instanceName}"/>
                </fmt:message>
            </fmt_rt:bundle>
        </p>
    </stripes:layout-component>
