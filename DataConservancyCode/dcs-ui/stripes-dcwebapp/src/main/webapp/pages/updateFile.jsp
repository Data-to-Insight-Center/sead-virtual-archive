    ...
    <stripes:layout-component name="contents">
        <div class="content-left-col">
            <stripes:form beanclass="org.dataconservancy.ui.stripes.DepositActionBean" class="DataDepositForm">
                ...
                <span class="SectionHeader">Select file(s) to deposit.  The uploaded file will <strong>replace</strong> the previously selected data item.</span>
                <div class="SectionContent">
                    ...
                    <fieldset>
                        ...
                        <stripes:hidden name="datasetToUpdateId" />
                    </fieldset>
                    <fieldset>
