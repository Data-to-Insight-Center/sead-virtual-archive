...
/**
 * Sends email to a user when they register.  This <em>must</em> be configured
 * to use the Velocity template {@code /templates/user-registration-notification.vm}.
 */

public class RegistrationUserNotificationEventListener extends NotificationServiceEventListener{
         ...
         */
        public RegistrationUserNotificationEventListener(NotificationService notificationService,
        ...
        /**
         * Returns true if the Event is a {@link org.dataconservancy.ui.eventing.api.EventTopic#REGISTRATION}, of class {@link org.dataconservancy.ui.eventing.api.EventClass#AUDIT}, and the
         * object is a {@link org.dataconservancy.ui.model.Person}.
         *
