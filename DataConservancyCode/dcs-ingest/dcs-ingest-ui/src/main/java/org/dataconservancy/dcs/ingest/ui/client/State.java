...
/**
 * Mapping between user actions and history tokens. Arguments to user actions
 * are separated by ';' with ';;' for literal ';'.
 */

// TODO rename, really web client state

public enum State {
    HOME("home"), FILE("file"), DELIVERABLE_UNIT("deliverableunit"),
    COLLECTION("collection"), SUBMIT("submit");
