...
public class CollectionMapper
    ...
    public CollectionMapper(Dcp aip) {
        super(aip);
    ...
    public FedoraDigitalObject map(DcsEntity in) throws AIPFormatException {
        ...
        DcsCollection entity = null;
        if ((in != null) && (DcsCollection.class == in.getClass())) {
            entity = (DcsCollection) in;
        } else {
        ...
        // Default Title
        String title = "Collection: " + entity.getId();
        ...
        erdfecmodel.setResource("info:fedora/dcs:Collection");
