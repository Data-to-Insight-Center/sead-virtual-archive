...
public class ManifestationMapper
    ...
    public ManifestationMapper(Dcp aip) {
        super(aip);
    }
    ...
    public FedoraDigitalObject map(DcsEntity in) throws AIPFormatException {
        ...
        DcsManifestation entity = null;
        if ((in != null) && (DcsManifestation.class == in.getClass())) {
            entity = (DcsManifestation) in;
        } else {
        ...
        // Default Title
        String title = "Manifestation: " + entity.getId();
        ...
        // No title in Manifestation but Fedora needs a DC title.
        ...
        erdfecmodel.setResource("info:fedora/dcs:Manifestation");
