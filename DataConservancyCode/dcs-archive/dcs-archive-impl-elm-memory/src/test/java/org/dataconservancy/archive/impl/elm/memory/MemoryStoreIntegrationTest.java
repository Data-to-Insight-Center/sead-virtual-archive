...
import org.dataconservancy.archive.impl.elm.memory.MemoryEntityStore;
import org.dataconservancy.archive.impl.elm.memory.MemoryMetadataStore;

public class MemoryStoreIntegrationTest {
    ...
    public void smokeTest() throws Exception {
        ...
        IOUtils.toString(store.getFullPackage("example:/DeliverableUnit/child"));
    ...
    public static void init() {
        ...
        store.setEntityStore(new MemoryEntityStore());
        store.setMetadataStore(new MemoryMetadataStore());
