...
/**
 * Logic which implements a full dip consisting of a tree of
 * <em>significantly related</em> entities.
 * <p>
 * Uses the definition of significantly related as per
 * {@link ArchiveStore#getFullPackage(String)}
 * </p>
 */
public class SignificantlyRelatedFullDipTreeLogic
        implements DipLogic {
    ...
    private Set<String> getCollectionEntities(String entityId,
        ...
        try {
            ...
            /*
             * A collection's metadata files are significantly related
             */
        ...
        /* A collections events are significantly related */
    ...
    private Set<String> getDeliverableUnitEntities(String entityId,
        ...
        try {
            ...
            /* A Du's metadata files are significantly related */
        ...
        /* Events and manifestations are significantly related */
    ...
    private Set<String> getManifestationEntities(String entityId,
        ...
        try {
            ...
            /*
             * A manifestation's metadata files are significantly related
             */
            for (DcsEntityReference ref : man.getMetadataRef()) {
                entities.add(ref.getRef());
            }

            /* A manifestation's files are significantly related */
    ...
    private Set<String> getFileEntities(String entityId,
        ...
        try {
            ...
            /*
             * A file's metadata files are significantly related
             */
