...
public class DefaultFieldComparator implements Comparator<Field> {
     ...
     * considered equal.
     * <p/>
     * <em><strong>N.B.</strong></string></em> When testing the type, generics are not taken into consideration.
     * <em><strong>N.B.</strong></string></em> Field value is not taken into consideration.
     * <p/>
