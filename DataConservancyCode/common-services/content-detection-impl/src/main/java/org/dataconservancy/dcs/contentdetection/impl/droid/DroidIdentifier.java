...
public class DroidIdentifier {
    ...
    private void initializeDroid() {
        try {
            ...
            droid.setSignatureFile(signatureFile);
            droid.init();
            ...
            ole2Identifier.setSignatureFilePath(containerSignatureFile);
            ...
            zipIdentifier.setSignatureFilePath(containerSignatureFile);
    ...
    private void setSignatureFiles() {
        ...
        signatureFile = droidSignatureFile.getSignatureFile();
        containerSignatureFile = droidSignatureFile.getContainerSignatureFile();
    }
