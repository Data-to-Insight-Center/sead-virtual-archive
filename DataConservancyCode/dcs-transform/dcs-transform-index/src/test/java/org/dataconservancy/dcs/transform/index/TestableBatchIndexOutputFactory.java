...
import org.dataconservancy.dcs.transform.index.BatchIndexOutputFactory;

public abstract class TestableBatchIndexOutputFactory<K, V>
        extends BatchIndexOutputFactory<K, V> {

    public TestableBatchIndexOutputFactory(IndexService<V> svc) {
        super(svc);
    }
     ...
     */
    public abstract int closeAndCount(boolean... success);
